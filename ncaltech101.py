...
NCALTECH101 = select_base_class(BaseClass = BaseDataset)
NCALTECH101InMemory = select_base_class(BaseClass = BaseInMemoryDataset)

if __name__ == '__main__':
    dataset  = NCALTECH101(dataset_path, transform = None)
    dataset_in_memory = NCALTECH101InMemory(dataset_path, transform = None)
    print("Good bye!")
